...
function UpdateFormulaire(props) {
  const { show, hideModal, pub, setPub, updatePub, clearInputs } = props;
    ...
    show && (
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button size="small" type="submit" variant="contained" color="primary" >Modifier</Button>
